...
EventYoshi.prototype.add = function(ee) {
  if (this.children.indexOf(ee) === -1) {
    ...
    var listen = function(event, listener) {
      ...
      var i;
      if ((i = self.__EventYoshi.indexOf(listener)) !== -1) {
        return;
      }
...
EventYoshi.prototype.on = function(event, listener) {
  ...
  var i = this.__EventYoshi.length;
  this.__EventYoshi.push(wrapper);
 ...
 * @param (Object...) args
 */
EventYoshi.prototype.emit = function() {
  var args = arguments;
